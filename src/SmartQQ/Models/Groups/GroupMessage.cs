...
namespace SmartQQ.Models
{
    ...
    {
        [JsonIgnore]
        private readonly LazyHelper<Group> _group = new LazyHelper<Group>();

        [JsonIgnore]
        private readonly LazyHelper<bool> _mentionedMe = new LazyHelper<bool>();

        [JsonIgnore]
        private readonly LazyHelper<GroupMember> _sender = new LazyHelper<GroupMember>();
